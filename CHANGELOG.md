...
- Initial release of the `changeset` mountable Rails engine
...
- Replaced the custom hook DSL with standard Rails callbacks, `Changeset::Current`, and `ActiveSupport::Notifications`
...
- Added a public documentation site at `https://changeset.dhairyagabhawala.com`
